...
import static ast.code.parser.javacodeparser.models.ClassType.ASYNC_TASK;
import static ast.code.parser.javacodeparser.utils.Utils.unsupported;

public class IsAsyncTask implements Command<DependencyModel> {
    private final TypeDeclaration typeDeclaration;
    private final DependencyModel dependencyModel = new DependencyModel();

    public IsAsyncTask(TypeDeclaration typeDeclaration) {
